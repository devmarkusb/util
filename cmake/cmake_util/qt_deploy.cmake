...
macro(ul_qt_deploy target path_to_qml)
    ...
    if(UL_WINDOWS)
        ...
        add_custom_command(
            ...
            POST_BUILD
            COMMAND
                "${UL_CMAKE_UTIL_DIR}/assets/qt_deploy_autodepends_win.bat"
                "${RUNTIME_OUTPUT_DIRECTORY_PACKAGESUBDIR}"
                "${UL_QT_INSTALL_PREFIX}/bin" ${impl_TargetBuildType} -qml
    ...
    elseif(UL_LINUX AND "${UL_DEPLOY_TARGET}" STREQUAL "linuxAppDir")
        add_custom_command(
            ...
            POST_BUILD
            COMMAND
                "${UL_CMAKE_UTIL_DIR}/assets/qt_deploy_autodepends_linux.sh"
                "${UL_RUNTIME_OUTPUT_DIRECTORY_PACKAGESUBDIR_BASE}/usr/share/applications/${impl_TargetFileName}.desktop"
                -bundle-non-qt-libs -qmake="${UL_QT_INSTALL_PREFIX}/bin/qmake"
        ...
        add_custom_command(
            ...
            POST_BUILD
            COMMAND
                "${UL_CMAKE_UTIL_DIR}/assets/appimagetool-x86_64.AppImage"
                "${target}.app"
            WORKING_DIRECTORY "${CMAKE_RUNTIME_OUTPUT_DIRECTORY}"
        )
    ...
    elseif(UL_MACOS)
        add_custom_command(
            ...
            POST_BUILD
            COMMAND
                "${UL_CMAKE_UTIL_DIR}/assets/qt_deploy_autodepends_macos.sh"
                "${UL_RUNTIME_OUTPUT_DIRECTORY_PACKAGESUBDIR_BASE}"
                "${UL_QT_INSTALL_PREFIX}/bin" -verbose=3 -dmg
