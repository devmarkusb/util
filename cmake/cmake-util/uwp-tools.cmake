...
set(MB_UL_IMPL_UWP_TOOLS_CURRENT_LIST_DIR ${CMAKE_CURRENT_LIST_DIR})

# can be used as default parameter for mb_ul_obtain_UWP_resources
set(MB_UL_CMAKE_INC_UWP_TOOLS_DEF_ICO
    ${CMAKE_CURRENT_LIST_DIR}/assets
    CACHE INTERNAL
    "can be used as default parameter for mb_ul_obtain_UWP_resources of MB_UL_CMAKE_INC_UWP_TOOLS"
    FORCE
)

# Usage (e.g.):
#   mb_ul_obtain_UWP_resources("App name" "Enterprise" "34799Enterprise.Appname" "" "348B82EC-3E83-499C-91B3-A2DAB20E041A" ""
#       "${PROJECT_VERSION}"
#       "${CMAKE_SOURCE_DIR}/installer/_content_for_bindir"
#       "#336699"
#       "<Resource Language=\"en\" /><Resource Language=\"de\" />"
#       Target_UWP_ASSETS)
#   For quick tests you can also use ${MB_UL_CMAKE_INC_UWP_TOOLS_DEF_ICO} for the _ico parent path and pass "" as PUBLISHER_NAME,
#   PHONE_PRODUCT_GUID, PHONE_PUBLISHER_GUID and LANGUAGES.
function(
    mb_ul_obtain_UWP_resources
    DISPLAYNAME
    ...
    if("${MB_UL_DEPLOY_TARGET}" STREQUAL "uwp")
        ...
        configure_file(
            "${MB_UL_IMPL_UWP_TOOLS_CURRENT_LIST_DIR}/assets/${APP_MANIFEST_NAME}.in"
            "${CMAKE_CURRENT_BINARY_DIR}/${APP_MANIFEST_NAME}"
            @ONLY
        )
        file(
            COPY "${FULLPATH_TO_ico_PARENTDIR}/_ico"
            DESTINATION "${CMAKE_CURRENT_BINARY_DIR}"
        )
        file(GLOB retRESOURCES_IMPL "${CMAKE_CURRENT_BINARY_DIR}/_ico/*.png")
        list(
            APPEND retRESOURCES_IMPL
            "${CMAKE_CURRENT_BINARY_DIR}/${APP_MANIFEST_NAME}"
        )
