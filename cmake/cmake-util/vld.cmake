...
option(MB_UL_COMPILE_WITH_VISUAL_LEAK_DETECTOR "With Visual Leak Detection" OFF)

if(MB_UL_COMPILE_WITH_VISUAL_LEAK_DETECTOR AND MSVC)
    ...
    find_library(
        ...
        HINTS
            ...
            "c:/Program Files/Visual Leak Detector/lib/Win32"
    )
    find_file(
        VLD_H
        vld.h
