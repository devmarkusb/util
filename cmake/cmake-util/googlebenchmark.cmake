...
set(MB_UL_SAVED_CMAKE_C_FLAGS "${CMAKE_C_FLAGS}")
set(MB_UL_SAVED_CMAKE_C_FLAGS_DEBUG "${CMAKE_C_FLAGS_DEBUG}")
set(MB_UL_SAVED_CMAKE_C_FLAGS_RELEASE "${CMAKE_C_FLAGS_RELEASE}")
set(MB_UL_SAVED_CMAKE_C_FLAGS_RELWITHDEBINFO "${CMAKE_C_FLAGS_RELWITHDEBINFO}")
set(MB_UL_SAVED_CMAKE_C_FLAGS_MINSIZEREL "${CMAKE_C_FLAGS_MINSIZEREL}")
set(MB_UL_SAVED_CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS}")
set(MB_UL_SAVED_CMAKE_CXX_FLAGS_DEBUG "${CMAKE_CXX_FLAGS_DEBUG}")
set(MB_UL_SAVED_CMAKE_CXX_FLAGS_RELEASE "${CMAKE_CXX_FLAGS_RELEASE}")
set(MB_UL_SAVED_CMAKE_CXX_FLAGS_RELWITHDEBINFO
    "${CMAKE_CXX_FLAGS_RELWITHDEBINFO}"
)
set(MB_UL_SAVED_CMAKE_CXX_FLAGS_MINSIZEREL "${CMAKE_CXX_FLAGS_MINSIZEREL}")
set(MB_UL_SAVED_CMAKE_EXE_LINKER_FLAGS "${CMAKE_EXE_LINKER_FLAGS}")
set(MB_UL_SAVED_CMAKE_SHARED_LINKER_FLAGS "${CMAKE_SHARED_LINKER_FLAGS}")
if(MSVC)
    set(MB_UL_BENCHMARK_MINIMAL_C_FLAGS "")
    set(MB_UL_BENCHMARK_MINIMAL_CXX_FLAGS "/std:c++${CMAKE_CXX_STANDARD}")
    set(MB_UL_BENCHMARK_MINIMAL_EXE_LINKER_FLAGS "")
    ...
    set(MB_UL_BENCHMARK_MINIMAL_C_FLAGS "-pthread")
    set(MB_UL_BENCHMARK_MINIMAL_CXX_FLAGS
        "-std=c++${CMAKE_CXX_STANDARD} -pthread"
    )
    set(MB_UL_BENCHMARK_MINIMAL_EXE_LINKER_FLAGS
        "${MB_UL_SAVED_CMAKE_EXE_LINKER_FLAGS} -pthread"
    )
    set(MB_UL_BENCHMARK_MINIMAL_SHARED_LINKER_FLAGS
...
set(CMAKE_CXX_FLAGS
    "${MB_UL_BENCHMARK_MINIMAL_CXX_FLAGS}"
    CACHE STRING
...
set(CMAKE_EXE_LINKER_FLAGS
    "${MB_UL_BENCHMARK_MINIMAL_EXE_LINKER_FLAGS}"
    CACHE STRING
    "Minimal for benchmark FindThreads link"
    FORCE
)
set(CMAKE_SHARED_LINKER_FLAGS
    "${MB_UL_BENCHMARK_MINIMAL_SHARED_LINKER_FLAGS}"
    CACHE STRING
    "Minimal for benchmark FindThreads link"
    FORCE
)
...
set(MB_UL_benchmark_src "${CMAKE_BINARY_DIR}/_deps/googlebenchmark-src")
if(EXISTS "${MB_UL_benchmark_src}/CMakeLists.txt")
    ...
    set(MB_UL_clone_result 1)
    set(MB_UL_attempt 0)
    while(MB_UL_attempt LESS 5)
        math(EXPR MB_UL_attempt_1 "${MB_UL_attempt} + 1")
        message(
            STATUS
            "Fetching google/benchmark (attempt ${MB_UL_attempt_1}/5)..."
        )
        ...
        execute_process(
            ...
            RESULT_VARIABLE MB_UL_clone_result
            OUTPUT_QUIET
            ERROR_QUIET
        )
        if(MB_UL_clone_result EQUAL 0)
            break()
        endif()
        file(REMOVE_RECURSE "${MB_UL_benchmark_src}")
        math(EXPR MB_UL_attempt "${MB_UL_attempt} + 1")
        if(MB_UL_attempt LESS 5)
            message(STATUS "Clone failed, retrying in 10 seconds...")
            execute_process(COMMAND ${CMAKE_COMMAND} -E sleep 10)
        endif()
    endwhile()
    if(NOT MB_UL_clone_result EQUAL 0)
        message(
            FATAL_ERROR
...
set(CMAKE_C_FLAGS
    "${MB_UL_SAVED_CMAKE_C_FLAGS}"
    CACHE STRING
    "C compiler flags"
    FORCE
)
set(CMAKE_C_FLAGS_DEBUG
    "${MB_UL_SAVED_CMAKE_C_FLAGS_DEBUG}"
    CACHE STRING
    "C compiler flags (Debug)"
    FORCE
)
set(CMAKE_C_FLAGS_RELEASE
    "${MB_UL_SAVED_CMAKE_C_FLAGS_RELEASE}"
    CACHE STRING
    "C compiler flags (Release)"
    FORCE
)
set(CMAKE_C_FLAGS_RELWITHDEBINFO
    "${MB_UL_SAVED_CMAKE_C_FLAGS_RELWITHDEBINFO}"
    CACHE STRING
    "C compiler flags (RelWithDebInfo)"
    FORCE
)
set(CMAKE_C_FLAGS_MINSIZEREL
    "${MB_UL_SAVED_CMAKE_C_FLAGS_MINSIZEREL}"
    CACHE STRING
    "C compiler flags (MinSizeRel)"
    FORCE
)
set(CMAKE_CXX_FLAGS
    "${MB_UL_SAVED_CMAKE_CXX_FLAGS}"
    CACHE STRING
    "C++ compiler flags"
    FORCE
)
set(CMAKE_CXX_FLAGS_DEBUG
    "${MB_UL_SAVED_CMAKE_CXX_FLAGS_DEBUG}"
    CACHE STRING
    "C++ compiler flags (Debug)"
    FORCE
)
set(CMAKE_CXX_FLAGS_RELEASE
    "${MB_UL_SAVED_CMAKE_CXX_FLAGS_RELEASE}"
    CACHE STRING
    "C++ compiler flags (Release)"
    FORCE
)
set(CMAKE_CXX_FLAGS_RELWITHDEBINFO
    "${MB_UL_SAVED_CMAKE_CXX_FLAGS_RELWITHDEBINFO}"
    CACHE STRING
    "C++ compiler flags (RelWithDebInfo)"
    FORCE
)
set(CMAKE_CXX_FLAGS_MINSIZEREL
    "${MB_UL_SAVED_CMAKE_CXX_FLAGS_MINSIZEREL}"
    CACHE STRING
    "C++ compiler flags (MinSizeRel)"
    FORCE
)
set(CMAKE_EXE_LINKER_FLAGS
    "${MB_UL_SAVED_CMAKE_EXE_LINKER_FLAGS}"
    CACHE STRING
    "Executable linker flags"
    FORCE
)
set(CMAKE_SHARED_LINKER_FLAGS
    "${MB_UL_SAVED_CMAKE_SHARED_LINKER_FLAGS}"
    CACHE STRING
