...
macro(ul_qt_deploy target path_to_qml)
    ...
    if(UL_WINDOWS)
        ...
        add_custom_command(
            ...
            POST_BUILD
            COMMAND
                "${UL_CMAKE_UTIL_DIR}/assets/qt-deploy-autodepends-win.bat"
                "${RUNTIME_OUTPUT_DIRECTORY_PACKAGESUBDIR}"
    ...
    elseif(UL_LINUX AND "${UL_DEPLOY_TARGET}" STREQUAL "linuxAppDir")
        add_custom_command(
            ...
            POST_BUILD
            COMMAND
                "${UL_CMAKE_UTIL_DIR}/assets/qt-deploy-autodepends-linux.sh"
        ...
        add_custom_command(
            ...
            POST_BUILD
            COMMAND
                "${UL_CMAKE_UTIL_DIR}/assets/appimagetool-x86-64.AppImage"
                "${target}.app"
            WORKING_DIRECTORY "${CMAKE_RUNTIME_OUTPUT_DIRECTORY}"
        )
    ...
    elseif(UL_MACOS)
        add_custom_command(
            ...
            POST_BUILD
            COMMAND
                "${UL_CMAKE_UTIL_DIR}/assets/qt-deploy-autodepends-macos.sh"
