set(TOO_ANDROID_TOOLCHAIN "qt" CACHE STRING "toolchain implementation to use for Android target")
...
if ("${TOO_ANDROID_TOOLCHAIN}" STREQUAL "native")
    include($ENV{ANDROID_NDK}/build/cmake/android.toolchain.cmake)
elseif ("${TOO_ANDROID_TOOLCHAIN}" STREQUAL "qt" OR "${TOO_ANDROID_TOOLCHAIN}" STREQUAL "qt_standalone")
    ...
    message(FATAL_ERROR "invalid choice of TOO_ANDROID_TOOLCHAIN")
endif ()
