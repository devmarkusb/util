...
set(impl_CustomTargetSpecifierHelpStr
    "can be used to append the bin dir 'bin_compiler' name by some custom string"
)
if(UL_ANDROID)
    set(UL_CUSTOM_TARGET_SPECIFIER
        "android"
        CACHE STRING
        "${impl_CustomTargetSpecifierHelpStr}"
        FORCE
    )
...
if(NOT "${UL_CUSTOM_TARGET_SPECIFIER}" STREQUAL "")
    set(impl_CompilerSubdir
        "${impl_CompilerSubdir}_${UL_CUSTOM_TARGET_SPECIFIER}"
    )
endif()
