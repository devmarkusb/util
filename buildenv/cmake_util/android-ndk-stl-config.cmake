...
function(configure_shared_stl lib_path so_base)
    ...
    message(
        "src file: ${ANDROID_NDK}/sources/cxx-stl/${lib_path}/libs/${ANDROID_ABI}/lib${so_base}.so"
    )
    message("dst file: ${CMAKE_LIBRARY_OUTPUT_DIRECTORY}/lib${so_base}.so")
    configure_file(
...
elseif("${ANDROID_STL}" STREQUAL "c++_shared")
    ...
    message(
        FATAL_ERROR
        "STL configuration ANDROID_STL=${ANDROID_STL} is not supported"
    )
endif()
