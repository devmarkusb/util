#include "ul/basiccodesupport/floating_point.h"
...
TEST(FloatingPointTest, ApproxEqual) {
    ...
    EXPECT_FALSE(
        mb::ul::math::approx_equal(
            1.0, 1.0 + std::numeric_limits<double>::epsilon(), std::numeric_limits<double>::epsilon() / 2));
    ...
    EXPECT_FALSE(
        mb::ul::math::approx_equal(
            std::numeric_limits<double>::quiet_NaN(), std::numeric_limits<double>::quiet_NaN(), 0.0001));

    // Test with infinity
    EXPECT_TRUE(
        mb::ul::math::approx_equal(
            std::numeric_limits<double>::infinity(), std::numeric_limits<double>::infinity(), 0.0001));
    EXPECT_TRUE(
        mb::ul::math::approx_equal(
            -std::numeric_limits<double>::infinity(), -std::numeric_limits<double>::infinity(), 0.0001));
    EXPECT_FALSE(
...
TEST(FloatingPointTest, ToStringFixed) {
    ...
    // Test with NaN
    EXPECT_EQ(
        mb::ul::math::to_string<mb::ul::math::FloatFormat::fixed>(std::numeric_limits<double>::quiet_NaN()), "nan");
    EXPECT_EQ(
        mb::ul::math::to_string<mb::ul::math::FloatFormat::fixed>(std::numeric_limits<double>::quiet_NaN(), 3), "nan");

    // Test with infinity
    EXPECT_EQ(
        mb::ul::math::to_string<mb::ul::math::FloatFormat::fixed>(std::numeric_limits<double>::infinity()), "inf");
    EXPECT_EQ(
        mb::ul::math::to_string<mb::ul::math::FloatFormat::fixed>(-std::numeric_limits<double>::infinity()), "-inf");
    EXPECT_EQ(
        mb::ul::math::to_string<mb::ul::math::FloatFormat::fixed>(std::numeric_limits<double>::infinity(), 3), "inf");
}
...
TEST(FloatingPointTest, ToStringScientific) {
    ...
    // Test with NaN
    EXPECT_EQ(
        mb::ul::math::to_string<mb::ul::math::FloatFormat::scientific>(std::numeric_limits<double>::quiet_NaN()),
        "nan");
    EXPECT_EQ(
        mb::ul::math::to_string<mb::ul::math::FloatFormat::scientific>(std::numeric_limits<double>::quiet_NaN(), 3),
        "nan");

    // Test with infinity
    EXPECT_EQ(
        mb::ul::math::to_string<mb::ul::math::FloatFormat::scientific>(std::numeric_limits<double>::infinity()), "inf");
    EXPECT_EQ(
        mb::ul::math::to_string<mb::ul::math::FloatFormat::scientific>(-std::numeric_limits<double>::infinity()),
        "-inf");
    EXPECT_EQ(
        mb::ul::math::to_string<mb::ul::math::FloatFormat::scientific>(std::numeric_limits<double>::infinity(), 3),
        "inf");
}
