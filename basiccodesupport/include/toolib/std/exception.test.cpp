...
{
    too::exception::Capture ec1{[](std::string s) { throw std::runtime_error{s}; }, "test error 1"};
    ...
    too::exception::Capture ec2{[]() { throw std::runtime_error{"test error 2"}; },};
    ...
    too::exception::Capture ec3{[]() { TOO_NOOP; }};
